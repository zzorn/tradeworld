...
public abstract class BaseComponent implements Component {
    ...
    public BaseComponent(Class<? extends Component> baseType) {
        ...
        if (!baseType.isAssignableFrom(getClass())) throw new IllegalArgumentException("The component type should be assignable to the specified base type.");
        this.baseType = baseType;

        componentTypeId = IdRegistry.getComponentTypeId(this.baseType);
    }
    ...
    public final void setEntity(Entity entity) {
        if (this.entity != null) throw new IllegalStateException("Can not add a component to more than one entity!  Already added to " + this.entity + ", can not also add to " + entity);
        ParameterChecker.checkNotNull(entity, "entity");
    ...
    public final void onRemoved() {
        if (entity == null) throw new IllegalStateException("Can not remove a component that has not been added to any entity");
