...
public class DefaultWorld implements World {
    ...
    public void setSimulationStepMilliseconds(long simulationStepMilliseconds) {
        ParameterChecker.checkPositiveNonZeroNormalNumber(simulationStepMilliseconds, "simulationStepMilliseconds");
    ...
    public void removeEntity(Entity entity) {
        ...
        ParameterChecker.check(entity.getWorld() == this, "entity", "The world of the removed entity should be the same as the world it is removed from.");
    ...
    public Entity createEntity(Component... components) {
        ...
        // Create entity class
        Entity entity = new Entity(entityId, this, components);
